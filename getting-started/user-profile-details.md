...
{% hint style="info" %}
_<mark style="color:blue;">**Timezone**</mark> <mark style="color:blue;"></mark><mark style="color:blue;">is</mark> <mark style="color:blue;"></mark><mark style="color:blue;">**NOT**</mark> <mark style="color:blue;"></mark><mark style="color:blue;">an editable field. This field is determined by the settings inside the users browser and can change if the settings inside the users browser changes.</mark>_
{% endhint %}
...
{% hint style="info" %}
_<mark style="color:blue;">For some users, the</mark>_ _<mark style="color:blue;">**Profile**</mark>_ _<mark style="color:blue;">page does not display the</mark>_ _<mark style="color:blue;">**Extended Profile**</mark>_ _<mark style="color:blue;">section, and this depends on the organization.</mark>_
{% endhint %}
...
* In the <mark style="color:blue;">**City**</mark> box, type the name of your city.
* In the <mark style="color:blue;">**State**</mark> box, type the name of your state.
* In the <mark style="color:blue;">**Country**</mark> box, type the name of your country.
* In the <mark style="color:blue;">**PostalCode**</mark> box, type your postal code number.
* In the <mark style="color:blue;">**Phone**</mark> box, type your telephone number.
* In the <mark style="color:blue;">**Mobile**</mark> box, type your mobile number.
* In the <mark style="color:blue;">**Fax**</mark> box, type your fax number.
* In the <mark style="color:blue;">**Caption**</mark> box, type the title name.
* Click <mark style="color:blue;">**Save**</mark>.
